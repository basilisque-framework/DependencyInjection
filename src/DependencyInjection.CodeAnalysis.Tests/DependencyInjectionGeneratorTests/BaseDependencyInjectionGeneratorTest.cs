...
namespace Basilisque.DependencyInjection.CodeAnalysis.Tests.DependencyInjectionGeneratorTests
{
    public abstract class BaseDependencyInjectionGeneratorTest
    {
        ...
        private List<(string Name, string SourceText)> getExpectedSources()
        {
            ...
            var assemblyNamespaceImplSrc = getAssemblyNamespaceImplSrc(rootNamespace);
            if (assemblyNamespaceImplSrc.HasValue)
                result.Add(assemblyNamespaceImplSrc.Value);

            result.Add(getRootNamespaceStubSrc(rootNamespace));
            result.Add(getServiceCollectionExtensionsSrc(rootNamespace));
            result.Add(getRootNamespaceImplSrc(rootNamespace));

            return result;
        }

        private (string, string)? getAssemblyNamespaceImplSrc(string? rootNamespace)
        {
...
{{
    ...
    {{
        ...
        private (string, string) getRootNamespaceStubSrc(string? rootNamespace)
        {
            var src = $@"//------------------------------------------------------------------------
// <auto-generated>
//   This code was generated by a tool.
...
{{
    ...
    {{
        ...
        private (string, string) getServiceCollectionExtensionsSrc(string? rootNamespace)
        {
            var src = $@"//------------------------------------------------------------------------
// <auto-generated>
//   This code was generated by a tool.
