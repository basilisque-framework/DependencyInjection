...
[TestClass]
public class Register_1Class_As_ITypeName_ClosedGeneric : BaseDependencyInjectionGeneratorTest
{
    protected override void AddSourcesUnderTest(SourceFileList sources)
    {
        ...
        namespace Some.Namespace
        {
            ...
            /// Test interface
            /// </summary>
            public interface IMyPublicRegisteredClass<TInterface>
            {
            }
        }");
        ...
        public class MyPublicRegisteredClass<TClass> : IMyPublicRegisteredClass<string>
        {
        }");
    }
    ...
    {
        return @"
        services.AddTransient(typeof(global::Some.Namespace.IMyPublicRegisteredClass<string>), typeof(global::MyPublicRegisteredClass<>));";
    }
}
