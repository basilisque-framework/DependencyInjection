...
[TestClass]
public class Register_1Class_As_ITypeName_OpenGeneric : BaseDependencyInjectionGeneratorTest
{
    protected override void AddSourcesUnderTest(SourceFileList sources)
    {
        ...
        public class MyPublicRegisteredClass<TClass> : IMyPublicRegisteredClass<TClass>
        {
        }");
    }
    ...
    {
        return @"
        services.AddTransient(typeof(global::Some.Namespace.IMyPublicRegisteredClass<>), typeof(global::MyPublicRegisteredClass<>));";
    }
}
