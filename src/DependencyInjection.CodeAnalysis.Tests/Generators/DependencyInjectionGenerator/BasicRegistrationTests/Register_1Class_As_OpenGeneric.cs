...
[TestClass]
public class Register_1Class_As_OpenGeneric : BaseDependencyInjectionGeneratorTest
{
    protected override void AddSourcesUnderTest(SourceFileList sources)
    {
        sources.Add(@"
        /// <summary>
        /// Test class that will be registered as open generic
        /// </summary>
    ...
    {
        return @"
        services.AddTransient(typeof(global::MyPublicRegisteredClass<>));";
    }
}
