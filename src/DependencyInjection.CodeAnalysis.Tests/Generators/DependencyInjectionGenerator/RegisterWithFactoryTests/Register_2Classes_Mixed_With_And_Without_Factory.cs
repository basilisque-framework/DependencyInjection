...
[TestClass]
public class Register_2Classes_Mixed_With_And_Without_Factory : BaseDependencyInjectionGeneratorTest
{
    protected override void AddSourcesUnderTest(SourceFileList sources)
    {
        ...
        public class MyFactory
        {
            ...
            public static MyPublicRegisteredClass NewMyPublicRegisteredClass(System.IServiceProvider serviceProvider)
            {
