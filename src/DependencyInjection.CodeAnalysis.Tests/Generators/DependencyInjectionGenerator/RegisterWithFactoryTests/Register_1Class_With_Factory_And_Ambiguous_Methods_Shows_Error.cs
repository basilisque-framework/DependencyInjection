...
[TestClass]
public class Register_1Class_With_Factory_And_Ambiguous_Methods_Shows_Error : BaseDependencyInjectionGeneratorTest
{
    protected override void AddSourcesUnderTest(SourceFileList sources)
    {
        ...
        public class MyFactory
        {
            ...
            /// <param name=""serviceProvider"">The service provider</param>
            /// <returns>An instance of the service</returns>
            public static MyPublicRegisteredClass Create2(System.IServiceProvider serviceProvider)
            {
                return new MyPublicRegisteredClass();
            }
        }
    ...
    {
        //error BAS_DI_003: Could not determine the factory method. Please ensure the factory 'global::MyFactory' contains a single method with the correct signature or provide the name of the method.
        yield return new Microsoft.CodeAnalysis.Testing.DiagnosticResult("BAS_DI_003", Microsoft.CodeAnalysis.DiagnosticSeverity.Error).WithSpan(5, 9, 8, 10);
    }
}
