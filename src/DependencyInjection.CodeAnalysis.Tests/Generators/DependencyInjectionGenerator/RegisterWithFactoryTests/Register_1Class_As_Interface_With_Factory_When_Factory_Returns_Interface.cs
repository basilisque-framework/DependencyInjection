...
[TestClass]
public class Register_1Class_As_Interface_With_Factory_When_Factory_Returns_Interface : BaseDependencyInjectionGeneratorTest
{
    protected override void AddSourcesUnderTest(SourceFileList sources)
    {
        ...
        public class MyFactory
        {
            ...
            public static IMyPublicRegisteredClass Create(System.IServiceProvider serviceProvider)
            {
    ...
    {
        return @"
        services.AddSingleton<global::IMyPublicRegisteredClass>(global::MyFactory.Create);";
    }
}
