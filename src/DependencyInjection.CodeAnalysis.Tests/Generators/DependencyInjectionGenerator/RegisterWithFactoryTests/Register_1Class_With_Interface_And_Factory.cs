...
[TestClass]
public class Register_1Class_With_Interface_And_Factory : BaseDependencyInjectionGeneratorTest
{
    protected override void AddSourcesUnderTest(SourceFileList sources)
    {
        ...
        public class MyFactory
        {
            ...
            public static MyPublicRegisteredClass CreateInstance(System.IServiceProvider serviceProvider)
            {
        ...
        /// Test class that will be registered with the factory method.
        /// </summary>
        [Basilisque.DependencyInjection.Registration.Annotations.RegisterServiceScoped(Factory = typeof(MyFactory))]
