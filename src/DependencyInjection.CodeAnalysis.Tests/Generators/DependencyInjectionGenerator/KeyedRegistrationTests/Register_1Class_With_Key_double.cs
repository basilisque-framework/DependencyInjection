...
[TestClass]
public class Register_1Class_With_Key_double : BaseDependencyInjectionGeneratorTest
{
    protected override void AddSourcesUnderTest(SourceFileList sources)
    {
        ...
        /// </summary>
        [Basilisque.DependencyInjection.Registration.Annotations.RegisterServiceScoped(Key = 3.14)]
    ...
    {
        return @"
        services.AddKeyedScoped<global::MyPublicRegisteredClass>(3.14);";
    }
}
