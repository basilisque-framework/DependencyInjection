...
[TestClass]
public class Register_1Class_With_Key_single : BaseDependencyInjectionGeneratorTest
{
    protected override void AddSourcesUnderTest(SourceFileList sources)
    {
        ...
        /// </summary>
        [Basilisque.DependencyInjection.Registration.Annotations.RegisterServiceScoped(Key = 3.14f)]
    ...
    {
        return @"
        services.AddKeyedScoped<global::MyPublicRegisteredClass>(3.14f);";
    }
}
