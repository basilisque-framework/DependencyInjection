...
[TestClass]
public class Register_1Class_With_Key_long : BaseDependencyInjectionGeneratorTest
{
    protected override void AddSourcesUnderTest(SourceFileList sources)
    {
        ...
        /// </summary>
        [Basilisque.DependencyInjection.Registration.Annotations.RegisterServiceScoped(Key = (long)123)]
    ...
    {
        return @"
        services.AddKeyedScoped<global::MyPublicRegisteredClass>((long)123);";
    }
}
