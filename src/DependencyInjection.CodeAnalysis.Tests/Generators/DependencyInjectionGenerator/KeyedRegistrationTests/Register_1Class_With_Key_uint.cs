...
[TestClass]
public class Register_1Class_With_Key_uint : BaseDependencyInjectionGeneratorTest
{
    protected override void AddSourcesUnderTest(SourceFileList sources)
    {
        ...
        /// </summary>
        [Basilisque.DependencyInjection.Registration.Annotations.RegisterServiceScoped(Key = (uint)123)]
    ...
    {
        return @"
        services.AddKeyedScoped<global::MyPublicRegisteredClass>((uint)123);";
    }
}
