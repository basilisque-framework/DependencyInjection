...
[TestClass]
public class Register_1Class_With_Key_ushort : BaseDependencyInjectionGeneratorTest
{
    protected override void AddSourcesUnderTest(SourceFileList sources)
    {
        ...
        /// </summary>
        [Basilisque.DependencyInjection.Registration.Annotations.RegisterServiceScoped(Key = (ushort)123)]
    ...
    {
        return @"
        services.AddKeyedScoped<global::MyPublicRegisteredClass>((ushort)123);";
    }
}
