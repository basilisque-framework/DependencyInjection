...
[TestClass]
public class Register_1Class_With_Key_Array_of_int : BaseDependencyInjectionGeneratorTest
{
    protected override void AddSourcesUnderTest(SourceFileList sources)
    {
        ...
        /// </summary>
        [Basilisque.DependencyInjection.Registration.Annotations.RegisterServiceScoped(Key = new int[] { 1, 2, 3 })]
