...
[TestClass]
public class Register_1Class_With_Key_byte : BaseDependencyInjectionGeneratorTest
{
    protected override void AddSourcesUnderTest(SourceFileList sources)
    {
        ...
        /// </summary>
        [Basilisque.DependencyInjection.Registration.Annotations.RegisterServiceScoped(Key = (byte)42)]
    ...
    {
        return @"
        services.AddKeyedScoped<global::MyPublicRegisteredClass>((byte)42);";
    }
}
