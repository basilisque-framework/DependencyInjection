...
public class Register_1Class_With_Key_Array_of_Type : BaseDependencyInjectionGeneratorTest
{
    protected override void AddSourcesUnderTest(SourceFileList sources)
    {
        ...
        /// </summary>
        [Basilisque.DependencyInjection.Registration.Annotations.RegisterServiceScoped(Key = new System.Type[] { typeof(int), typeof(string) })]
    ...
    {
        return @"
        services.AddKeyedScoped<MyPublicRegisteredClass>(new System.Type[] { typeof(int), typeof(string) });";
    }
}
