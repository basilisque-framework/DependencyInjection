...
[TestClass]
public class Register_1Class_With_Key_int : BaseDependencyInjectionGeneratorTest
{
    protected override void AddSourcesUnderTest(SourceFileList sources)
    {
        ...
        /// </summary>
        [Basilisque.DependencyInjection.Registration.Annotations.RegisterServiceScoped(Key = 42)]
    ...
    {
        return @"
        services.AddKeyedScoped<global::MyPublicRegisteredClass>(42);";
    }
}
