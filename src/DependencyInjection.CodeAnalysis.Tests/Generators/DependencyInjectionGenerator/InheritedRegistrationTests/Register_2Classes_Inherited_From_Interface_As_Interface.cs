...
[TestClass]
public class Register_2Classes_Inherited_From_Interface_As_Interface : BaseDependencyInjectionGeneratorTest
{
    protected override void AddSourcesUnderTest(SourceFileList sources)
    {
        ...
        /// Test class that will be registered as transient by attribute
        /// </summary>
        public class MyPublicRegisteredClass2 : ISomeInterface
        {
        }");
    }
